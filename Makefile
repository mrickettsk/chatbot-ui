...
tf-plan:
	cd terraform/envs/stable && terraform plan -var="openai_api_key=${OPENAI_API_KEY}" -var="openai_api_url=${OPENAI_API_URL}" -var="allowed_inbound_ips=${ALLOWED_INBOUND_IPS}" -out=out.tfplan
